...
export const getAgentStatementsColumns = (onDownload) => [
  {
    id: "period",
    header: "Period",
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-start gap-3 py-1">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-blue-600 dark:bg-blue-500/10">
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const amount = statementData?.revenue?.net_profit || 0;
      return (
