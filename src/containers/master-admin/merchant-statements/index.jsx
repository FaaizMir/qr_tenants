...
import { getMerchantStatementsColumns } from "./merchant-statements-columns";
import useDebounce from "@/hooks/useDebounceRef";

export default function MerchantStatementsContainer() {
  ...
  const columns = getMerchantStatementsColumns(handleDownloadPdf);
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl">
              Monthly auto-generated PDF reports including coupon stats,
              WhatsApp usage, and ad spend.
            </p>
          </div>
        </div>
      </div>
