...
const PLATFORMS = [
    { id: "google", name: "Google Reviews", icon: "G", color: "bg-blue-600 hover:bg-blue-700" },
    { id: "facebook", name: "Facebook", icon: "f", color: "bg-blue-600 hover:bg-blue-700" },
    { id: "instagram", name: "Instagram", icon: "I", color: "bg-pink-600 hover:bg-pink-700" },
    { id: "red", name: "XiaoHongShu", icon: "RED", color: "bg-red-500 hover:bg-red-600" },
];
        ...
        return (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-muted-foreground">Please tell us about yourself to get started.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full h-12 text-lg font-medium mt-6 bg-gradient-to-r from-primary to-primary-hover hover:opacity-90 transition-all shadow-lg hover:shadow-xl">
        ...
        return (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="text-center space-y-2">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight">Rate Your Experience</h2>
                    <p className="text-muted-foreground">How was your visit to {merchantConfig.name}?</p>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {PLATFORMS.map(platform => (
                            <Button
                                key={platform.id}
                                variant="outline"
                                className={cn("h-12 relative overflow-hidden group border-2",
                                    review.platform === platform.id ? "border-primary bg-primary/5" : "hover:border-primary/50"
                                )}
                                onClick={() => handlePlatformSelect(platform.id)}
                                disabled={loading}
                            >
                                <span className={cn("mr-2 font-bold",
                                    platform.id === 'google' ? "text-blue-500" :
                                        platform.id === 'facebook' ? "text-blue-600" :
                                            platform.id === 'instagram' ? "text-pink-600" : "text-red-500"
                                )}>
                                    {platform.icon}
                                </span>
                                {platform.name}
        ...
        return (
            <div className="text-center space-y-6 py-10 animate-in fade-in zoom-in duration-500">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">Please wait while we verify your submission.</p>
                </div>
            </div>
        );
    };
        ...
        if (result) {
            return (
                <div className="text-center space-y-6 py-10 animate-in zoom-in duration-500">
                    ...
                    <h2 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-orange-500">
                        YOU WON!
                    </h2>
        ...
        return (
            <div className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="relative w-64 h-64 mx-auto my-8">
                    ...
                    <div className={cn(
                        "w-full h-full rounded-full border-8 border-primary/20 relative overflow-hidden transition-transform duration-[3000ms] ease-out",
                        spinning && "rotate-[1080deg]"
                    )}
                        style={{ background: 'conic-gradient(from 0deg, #ff8b8b 0deg 90deg, #8ba8ff 90deg 180deg, #8bffc5 180deg 270deg, #fff78b 270deg 360deg)' }}
                    >
                    ...
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 z-20">
                        <div className="w-0 h-0 border-l-[10px] border-l-transparent border-t-[20px] border-t-primary border-r-[10px] border-r-transparent"></div>
                    </div>
                </div>
                ...
                <Button
                    ...
                    onClick={handleSpin}
                    disabled={spinning}
                    className="w-full h-14 text-xl font-bold bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 shadow-xl"
                >
        ...
        return (
            <div className="space-y-6 animate-in fade-in zoom-in duration-700">
                <div className="text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold text-green-700">Sent to WhatsApp!</h2>
                    ...
                    <p className="text-muted-foreground px-4">
                        ...
                        <span className="font-semibold block text-foreground mt-1 text-lg">{customer.phone}</span>
                    </p>
                </div>
                ...
                <Card className="border-2 border-dashed border-primary/30 bg-primary/5">
                    <CardContent className="p-6 flex flex-col items-center space-y-4">
                        ...
                        <div className="text-center space-y-1">
                            <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider">Your Reward</p>
                            <h3 className="text-2xl font-bold text-primary">{reward?.name || "Special Offer"}</h3>
                        </div>
                        ...
                        <div className="flex items-center gap-3 text-sm text-left text-muted-foreground w-full bg-white p-3 rounded border">
                            ...
                            <div>
                                <p className="font-semibold text-foreground">Strictly No Copying</p>
                                <p className="text-xs">Your unique redemption QR code is waiting in your WhatsApp chat.</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <div className="bg-muted p-4 rounded-lg flex items-start gap-3 text-sm">
                    ...
                    <p>
                        Simply show the WhatsApp message to our staff to redeem your reward. No need to copy codes!
                    </p>
                </div>
            </div>
        );
    ...
    const ThankYou = () => {
        return (
            <div className="text-center space-y-6 py-10 animate-in fade-in zoom-in duration-500">
                ...
                <div className="space-y-2">
                    <h2 className="text-3xl font-bold text-blue-900">Thanks for Reviewing!</h2>
                    <p className="text-muted-foreground">
                        Your feedback helps us serve you better. We hope to see you again soon at <b>{merchantConfig.name}</b>.
                    </p>
                </div>
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50/50 dark:bg-zinc-950 p-4">
            ...
            <Card className="w-full max-w-md shadow-2xl border-0 overflow-hidden backdrop-blur-sm bg-card/95">
                ...
                <div className="h-32 bg-gradient-to-r from-primary/80 to-purple-600/80 relative flex items-center justify-center">
                    <div className="absolute inset-0 bg-black/10"></div>
                    <div className="z-10 text-center text-white p-4">
                        <h1 className="text-2xl font-bold drop-shadow-md">{merchantConfig.name}</h1>
                ...
                <CardContent className="p-6">
                    ...
                    {step === 3 && <RedirectWait />}
                    {step === 4 && (
                        merchantConfig.rewardType === 'lucky_draw' ? <LuckyDraw /> :
                            merchantConfig.rewardType === 'coupon' ? <RewardSuccess /> :
                                <ThankYou />
                    )}
