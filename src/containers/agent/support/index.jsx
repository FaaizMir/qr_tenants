      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-muted-foreground">
            Level-1 Support Desk for your onboarded merchants.
          </p>
        </div>
      </div>
            ...
            <ScrollArea className="h-full">
              {tickets.map((ticket) => (
                <div
                  ...
                  className={`p-4 border-b cursor-pointer transition-colors hover:bg-muted/40 group ${
          ...
          {selectedTicket ? (
              ...
              <CardHeader className="border-b py-3 px-6 bg-muted/5">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="flex items-center gap-3 text-sm text-muted-foreground mt-1">
                      <span className="flex items-center gap-1">
                        <User className="h-3 w-3" /> {selectedTicket.merchant}
                      </span>
                      <span>•</span>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <ArrowUpRight className="h-4 w-4 mr-2" /> Escalate to
                      Admin
                    </Button>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3">
                      <div className="bg-primary text-primary-foreground rounded-2xl rounded-tr-none p-4 max-w-[80%] shadow-sm">
                        <p className="text-sm leading-relaxed">
                          Hello! I can certainly help with that. Could you
                          please provide a screenshot of the error you are
                          seeing?
                        </p>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex gap-2 text-xs text-muted-foreground">
                        ...
                        <span>
                          Pressing <strong>Enter</strong> sends the message
                        </span>
                      </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground bg-muted/5 p-8 text-center">
              ...
              <p className="max-w-xs">
                Click on a conversation from the left sidebar to view details
                and reply to merchants.
              </p>
            </div>
          )}
        </Card>
