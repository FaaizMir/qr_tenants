      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
        ...
        <TabsContent value="sync" className="space-y-6 mt-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card className="bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/20 shadow-sm border-blue-100">
              <CardHeader className="pb-2">
                <div className="flex items-center gap-2">
                  <Monitor className="h-5 w-5 text-blue-600" />
                  <h3 className="font-semibold text-blue-900 dark:text-blue-100">Live on Homepage</h3>
                </div>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold text-blue-700 dark:text-blue-300">124</div>
                <p className="text-xs text-blue-600/80 mt-1">Active coupons visible publicly</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">Requests waiting for Admin review</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-dashed bg-muted/20 flex flex-col justify-center items-center p-6 text-center">
              ...
              <p className="text-xs text-muted-foreground mt-2">Submit local coupons for global listing.</p>
            </Card>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track the status of your marketplace submission requests.</CardDescription>
            </CardHeader>
            <CardContent>
              <TableToolbar
                ...
                <CardHeader>
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <CardDescription>Performance of boosted coupons.</CardDescription>
                    </div>
            ...
            <div className="w-full lg:w-[350px] space-y-4">
              <Card className="bg-zinc-950 text-white border-zinc-800">
                <CardHeader>
                  ...
                  <CardDescription className="text-zinc-400">Past 30 Days</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div>
                    <div className="text-sm text-zinc-400 mb-1">Click-Through Rate</div>
                    <div className="text-2xl font-bold">3.8%</div>
                  </div>
                  <div>
                    <div className="text-sm text-zinc-400 mb-1">Total Convertions</div>
                    <div className="text-2xl font-bold">1,890</div>
                  </div>
                </CardContent>
                <CardFooter className="border-t border-zinc-800 pt-4">
                  <p className="text-xs text-zinc-500">Based on aggregate data from all your active campaigns.</p>
                </CardFooter>
              </Card>
              ...
              <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg text-amber-800 text-sm">
                ...
                Pricing and placement rules are controlled by the Admin. Available slots depend on region demand.
              </div>
            </div>
          </div>
        </TabsContent>
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <p className="text-xs text-muted-foreground text-right">15 Days</p>
            </div>
          </div>
          <DialogFooter>
